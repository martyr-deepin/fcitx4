...
int main() {
    ...
    TEST_HOTKEY_UNIFICATION(FcitxKey_F, FcitxKeyState_Ctrl_Shift, FcitxKey_F,
                            FcitxKeyState_Ctrl_Shift);
    TEST_HOTKEY_UNIFICATION(FcitxKey_F, FcitxKeyState_Ctrl, FcitxKey_F,
                            FcitxKeyState_Ctrl);
    TEST_HOTKEY_UNIFICATION(FcitxKey_f, FcitxKeyState_Ctrl_Shift, FcitxKey_F,
                            FcitxKeyState_Ctrl_Shift);
    TEST_HOTKEY_UNIFICATION(FcitxKey_f, FcitxKeyState_Ctrl_Alt, FcitxKey_F,
                            FcitxKeyState_Ctrl_Alt);
