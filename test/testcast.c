...
int main() {
     ...
     **/
#define def_test_type(name, type, val)                                         \
    do {                                                                       \
        type test_##name##_var1 = (type)(val);                                 \
        void *test_##name##_ptr1 = (void *)(intptr_t)test_##name##_var1;       \
        void *test_##name##_ptr2 =                                             \
            fcitx_utils_##name##_to_ptr(test_##name##_var1);                   \
        type test_##name##_var2 =                                              \
            fcitx_utils_ptr_to_##name(test_##name##_ptr1);                     \
        type test_##name##_var3 =                                              \
            fcitx_utils_ptr_to_##name(test_##name##_ptr2);                     \
