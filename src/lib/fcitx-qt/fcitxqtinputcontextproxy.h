 ...
 */
class FCITX_QT_EXPORT_API FcitxQtInputContextProxy
...
public:
    FcitxQtInputContextProxy(const QString &service, const QString &path,
...
Q_SIGNALS: // SIGNALS
    ...
    void UpdateClientSideUI(const QString &auxup, const QString &auxdown,
                            const QString &preedit,
                            const QString &candidateword, const QString &imname,
                            int cursorpos);
