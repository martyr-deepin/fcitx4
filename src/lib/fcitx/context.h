...
/** alternative prevpage key, if this input method requires different key for
 * paging */
#define CONTEXT_ALTERNATIVE_PREVPAGE_KEY "CONTEXT_ALTERNATIVE_PREVPAGE_KEY"
/** alternative nextpage key, if this input method requires different key for
 * paging */
...
/**
 * @brief bind a callback function to this context, callback will be called when
...
static inline const FcitxHotkey *FcitxConfigPrevPageKey(FcitxInstance *instance,
                                                        FcitxGlobalConfig *fc) {
...
static inline const FcitxHotkey *FcitxConfigNextPageKey(FcitxInstance *instance,
                                                        FcitxGlobalConfig *fc) {
