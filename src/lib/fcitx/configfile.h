...
typedef struct _FcitxConfig {
    ...
    boolean bSendTextWhenSwitchEng; /**< switch to english with switch key
                                       commit string or not */
    int iMaxCandWord;               /**< max candidate word number */
    boolean bPhraseTips;            /**< phrase tips*/
    boolean
        bShowInputWindowTriggering; /**< show input window after trigger on*/
    ...
    boolean
        bHideInputWindowWhenOnlyPreeditString; /**< hide input window when there
                                                  is only preedit string*/
    boolean
        bHideInputWindowWhenOnlyOneCandidate; /**< hide input window when there
                                                 is only one candidate word*/
    FcitxHotkey hkSwitchEmbeddedPreedit[2]; /**< switch the preedit should show
                                               in client window or not*/
    ...
    boolean bIMSwitchKey; /**< Enable Left Ctrl + Left Shift to Switch Between
                             Input Method */
    boolean dummy;        /**< dummy */
    int _defaultIMState;  /**< default input method state */
    boolean bDontCommitPreeditWhenUnfocus; /**< commit preedit when unfocus or
                                              not */
