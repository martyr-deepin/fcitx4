 ...
 **/
boolean FcitxInstanceSetCurrentIC(struct _FcitxInstance *instance,
 ...
 **/
boolean FcitxInstanceRemoveTimeoutByFunc(FcitxInstance *instance,
                                         FcitxTimeoutCallback callback);
...
/**
 * run a fcitx instance in current thread, this function will not return until
 *fcitx finishes.
 *
