...
typedef struct _FcitxFrontend {
    void *(*Create)(struct _FcitxInstance *,
                    int frontendindex); /**< frontend create callback */
    boolean (*Destroy)(void *arg);      /**< frontend destroy callback */
    void (*CreateIC)(void *arg, FcitxInputContext *,
                     void *priv); /**< frontend create input context callback */
    boolean (*CheckIC)(
        void *arg, FcitxInputContext *arg1,
        void *arg2); /**< frontend check context with private value callback */
    void (*DestroyIC)(void *arg,
                      FcitxInputContext *context); /**< frontend destroy input
                                                      context callback */
    void (*EnableIM)(void *arg,
                     FcitxInputContext *arg1); /**< frontend enable input method
                                                  to client callback */
    void (*CloseIM)(void *arg,
                    FcitxInputContext *arg1); /**< frontend close input method
                                                 to client callback */
    void (*CommitString)(
        void *arg, FcitxInputContext *arg1,
        const char *arg2); /**< frontend commit string callback */
    void (*ForwardKey)(
        void *arg, FcitxInputContext *arg1, FcitxKeyEventType event,
        FcitxKeySym sym,
        unsigned int state); /**< frontend forward key callback */
    void (*SetWindowOffset)(void *arg, FcitxInputContext *ic, int x,
                            int y); /**< frontend set window offset callback */
    void (*GetWindowRect)(void *arg, FcitxInputContext *ic, int *x, int *y,
                          int *w,
                          int *h); /**< frontend get window position callback */
    void (*UpdatePreedit)(
        void *arg,
        FcitxInputContext *ic); /**< frontend update preedit callback */
    void (*UpdateClientSideUI)(
        void *arg,
        FcitxInputContext
            *ic); /**< frontend update client side user interface callback */
    ...
    boolean (*CheckICFromSameApplication)(
        ...
        FcitxInputContext *ic); /**< frontend check input context from same
                                   application callback */
    pid_t (*GetPid)(
        void *arg,
        FcitxInputContext *arg1); /**< get pid for ic, zero for unknown */
    void (*DeleteSurroundingText)(void *addonInstance, FcitxInputContext *ic,
                                  int offset, unsigned int size);
    boolean (*GetSurroundingPreedit)(void *addonInstance, FcitxInputContext *ic,
 ...
 **/
FcitxInputContext *FcitxInstanceFindIC(struct _FcitxInstance *instance,
                                       int frontendid, void *filter);
 ...
 * @return FcitxInputContext*
 **/
FcitxInputContext *FcitxInstanceCreateIC(struct _FcitxInstance *instance,
                                         int frontendid, void *priv);
 ...
 * @return void
 **/
void FcitxInstanceDestroyIC(struct _FcitxInstance *instance, int frontendid,
                            void *filter);
 ...
 * @return void
 **/
void FcitxInstanceCommitString(struct _FcitxInstance *instance,
 ...
 * @return boolean
 **/
boolean FcitxInstanceGetSurroundingText(struct _FcitxInstance *instance,
                                        FcitxInputContext *ic, char **str,
                                        unsigned int *cursor,
                                        unsigned int *anchor);
 ...
 * @return void
 **/
void FcitxInstanceSetWindowOffset(struct _FcitxInstance *instance,
                                  FcitxInputContext *ic, int x, int y);
 ...
 * @return void
 **/
void FcitxInstanceGetWindowPosition(struct _FcitxInstance *instance,
                                    FcitxInputContext *ic, int *x, int *y);
 ...
 * @return void
 **/
void FcitxInstanceGetWindowRect(struct _FcitxInstance *instance,
 ...
 * @return void
 **/
void FcitxInstanceUpdatePreedit(struct _FcitxInstance *instance,
                                FcitxInputContext *ic);

/**
 * Update all user interface element to client (Aux Text, Preedit, Candidate
 *Word)
 *
 * @param instance fcitx instance
 * @param ic input context
 * @return void
 **/
void FcitxInstanceUpdateClientSideUI(struct _FcitxInstance *instance,
                                     FcitxInputContext *ic);

/**
 * Get Current State, if only want to get state, this function is better,
 *because it will handle the case that Input Context is NULL.
 *
 * @param instance fcitx instance
 * @return IME_STATE
 **/
 ...
 **/
FcitxContextState
FcitxInstanceGetCurrentStatev2(struct _FcitxInstance *instance);

/**
 * get current ic capacity flag, if only want to get capacity, this function is
 *better, because it will handle the case that Input Context is NULL.
 *
 * @param instance fcitx instance
 * @return CapacityFlags
 **/
FcitxCapacityFlags
FcitxInstanceGetCurrentCapacity(struct _FcitxInstance *instance);
 ...
 * @return void
 **/
void FcitxInstanceSetICStateFromSameApplication(struct _FcitxInstance *instance,
                                                int frontendid,
                                                FcitxInputContext *ic);
 ...
 * @since 4.2.5
 **/
void *FcitxInstanceGetICData(struct _FcitxInstance *instance,
                             FcitxInputContext *ic, int icdataid);
 ...
 * @since 4.2.5
 **/
void FcitxInstanceSetICData(struct _FcitxInstance *instance,
                            FcitxInputContext *ic, int icdataid, void *newdata);

/**
 * alloc a per-ic data slot
 *
 * @param instance fcitx instnace
 * @param allocCallback alloc callback (set pointer to null, when callback is
 *null)
 ...
 * @since 4.2.5
 **/
int FcitxInstanceAllocDataForIC(struct _FcitxInstance *instance,
 ...
 * @since 4.2.5
 **/
boolean FcitxInstanceICSupportPreedit(struct _FcitxInstance *instance,
                                      FcitxInputContext *ic);
