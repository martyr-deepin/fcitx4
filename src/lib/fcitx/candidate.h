...
typedef INPUT_RETURN_VALUE (*FcitxCandidateWordCommitCallback)(
    void *arg, struct _FcitxCandidateWord *candWord);
 ...
 * @return void
 **/
void FcitxCandidateWordInsertPlaceHolder(
    struct _FcitxCandidateWordList *candList, int position);
 ...
 * @since 4.2.5
 **/
void FcitxCandidateWordMoveByWord(FcitxCandidateWordList *candList,
 ...
 * @since 4.2
 **/
void FcitxCandidateWordRemove(struct _FcitxCandidateWordList *candList,
                              FcitxCandidateWord *candWord);
 ...
 * @since 4.2.6
 **/
void FcitxCandidateWordRemoveByIndex(FcitxCandidateWordList *candList, int idx);
 ...
 * @since 4.2.5
 **/
void FcitxCandidateWordSetPage(struct _FcitxCandidateWordList *candList,
                               int index);
 ...
 * @since 4.2.1
 **/
void FcitxCandidateWordSetFocus(struct _FcitxCandidateWordList *candList,
                                int index);
 ...
 **/
FcitxCandidateWord *
FcitxCandidateWordGetCurrentWindow(struct _FcitxCandidateWordList *candList);

/**
 * get next word of current page, useful when you want to iteration over current
 *candidate words
 *
 * @param candList candidate word list
 ...
 **/
FcitxCandidateWord *
FcitxCandidateWordGetCurrentWindowNext(struct _FcitxCandidateWordList *candList,
                                       FcitxCandidateWord *candWord);

/**
 * get prev word of current page, useful when you want to iteration over current
 *candidate words
 *
 * @param candList candidate word list
 * @param candWord current cand word
 ...
 **/
FcitxCandidateWord *
FcitxCandidateWordGetCurrentWindowPrev(struct _FcitxCandidateWordList *candList,
                                       FcitxCandidateWord *candWord);
 ...
 **/
FcitxCandidateWord *
FcitxCandidateWordGetByTotalIndex(struct _FcitxCandidateWordList *candList,
                                  int index);
 ...
 **/
FcitxCandidateWord *
FcitxCandidateWordGetByIndex(struct _FcitxCandidateWordList *candList,
                             int index);
 ...
 **/
INPUT_RETURN_VALUE
FcitxCandidateWordChooseByIndex(struct _FcitxCandidateWordList *candList,
                                int index);
 ...
 **/
INPUT_RETURN_VALUE
FcitxCandidateWordChooseByTotalIndex(struct _FcitxCandidateWordList *candList,
                                     int index);
 ...
 * @return void
 **/
void FcitxCandidateWordSetChoose(struct _FcitxCandidateWordList *candList,
 ...
 * @return void
 **/
void FcitxCandidateWordSetChooseAndModifier(
    struct _FcitxCandidateWordList *candList, const char *strChoose,
    unsigned int state);
 ...
 **/
const char *
FcitxCandidateWordGetChoose(struct _FcitxCandidateWordList *candList);
 ...
 **/
unsigned int
FcitxCandidateWordGetModifier(struct _FcitxCandidateWordList *candList);
 ...
 * @return void
 **/
void FcitxCandidateWordResize(struct _FcitxCandidateWordList *candList,
                              int length);
 ...
 * @return int
 **/
int FcitxCandidateWordGetCurrentWindowSize(
 ...
 */
boolean
FcitxCandidateWordGetHasGoneToPrevPage(FcitxCandidateWordList *candList);
 ...
 */
boolean
FcitxCandidateWordGetHasGoneToNextPage(FcitxCandidateWordList *candList);
 ...
 **/
FcitxCandidateWord *
FcitxCandidateWordGetFirst(FcitxCandidateWordList *candList);
 ...
 * @return FcitxCandidateWord*
 **/
FcitxCandidateWord *FcitxCandidateWordGetNext(FcitxCandidateWordList *candList,
                                              FcitxCandidateWord *candWord);
 ...
 * @since 4.2.7
 **/
FcitxCandidateWord *FcitxCandidateWordGetPrev(FcitxCandidateWordList *candList,
                                              FcitxCandidateWord *candWord);
 ...
 * @since 4.2.7
 */
void FcitxCandidateWordSetLayoutHint(FcitxCandidateWordList *candList,
                                     FcitxCandidateLayoutHint hint);
 ...
 */
FcitxCandidateLayoutHint
FcitxCandidateWordGetLayoutHint(FcitxCandidateWordList *candList);
 ...
 * @since 4.2.8
 */
void FcitxCandidateWordSetOverrideDefaultHighlight(
    FcitxCandidateWordList *candList, boolean overrideValue);

/** convinient string for candidate word */
#define DIGIT_STR_CHOOSE "1234567890"

static inline void FcitxCandidateWordSetType(FcitxCandidateWord *cand_word,
                                             FcitxMessageType type) {
    cand_word->wordType =
        (FcitxMessageType)((cand_word->wordType & ~MSG_REGULAR_MASK) | type);
}
