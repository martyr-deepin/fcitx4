...
xim_externaldef XimFrameRec input_styles_fr[] = {
    ...
    _FRAME(POINTER), _PTR(inputstyle_fr), _FRAME(EOL),
};
...
xim_externaldef XimFrameRec str_conversion_reply_fr[] = {
    ...
    _PAD4(2),       _BYTE_COUNTER(BIT16, 2), /* number of feedback array */
    _PAD4(1),       _FRAME(ITER),            /* feedback array */
    _FRAME(BIT32),  _FRAME(EOL),
};
